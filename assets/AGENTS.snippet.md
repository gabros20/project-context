...
- Durable reasoning can require a checkpoint even when Git state is unchanged; use the skill explicitly at a meaningful boundary or choose the `every-turn` checkpoint gate when strict capture is desired.
